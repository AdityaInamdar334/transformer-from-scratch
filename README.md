...
The model has a total of **3,195,969 parameters** (~3.2M) configured as follows:

* **Vocabulary Size**: 65 characters (Tiny Shakespeare vocabulary)
* **Sequence Length (`seq_len`)**: 128 tokens
* **Dimension Model (`d_model`)**: 256
...
* **Token & Positional Embeddings**: 
  * Token Embeddings: $65 \times 256 = 16,640$ parameters
  * Positional Embeddings: $5,000 \times 256 = 1,280,000$ parameters
* **Transformer Stack (6 layers)**: ~1,882,624 parameters
  * Multi-head Self Attention: projection weights/biases for Q, K, V, and Output
  * Position-wise Feed-Forward Network: projections from $256 \to 512 \to 256$
  * Layer Normalization: Scale and bias parameters
* **LM Head (Output Projection)**: $256 \times 65 + 65 = 16,705$ parameters
